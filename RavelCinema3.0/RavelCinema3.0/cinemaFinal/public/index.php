...
// NORMALIZA O PATH (remove prefixo /cinemaFinal/public, etc.)
$base = rtrim(str_replace('\\','/', dirname($_SERVER['SCRIPT_NAME'] ?? '')), '/'); // ex.: /cinemaFinal/public
if ($base !== '' && $base !== '/') {
...
try {
  ...
  if ($method === 'POST'   && $path === '/cart/checkout') return Cart::checkout();
